...
Assignment: Twitter Sentiment Analysis in Python Problem 6
Program Description: top_ten.py
    This program computes the ten most frequently occurring hashtags
...
Output notes:
    ...
    Returns the following: <hashtag:string> <frequency:float>
    Example: (bar, 30)...the text appears as--> bar 30
"""
import sys
import json
import operator
