...
Assignment: Twitter Sentiment Analysis in Python Problem 5
Program Description: happiest_state.py
    This program computes the happiest state of the sentiment for each tweet
    based on the sentiment scores of the terms in the tweet. It is equivalent 
    to the sum of the sentiment scores from each term in the tweet.
Program Notes:
    Compilation Process--
...
Output notes:
    ...
    Returns the happiest state as a string. 
    Metric: average tweet happiness for each state
"""
