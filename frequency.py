...
Assignment: Twitter Sentiment Analysis in Python Problem 4
Program Description: term_sentiment.py
    This program computes the frequency of the sentiment for each tweet based on the sentiment scores of the
